...
from vllm_.entrypoints.openai.responses.protocol import (
    ResponseInputOutputItem,
    ResponsesRequest,
)
from vllm_.entrypoints.openai.responses.utils import (
    construct_input_messages,
)
from vllm_.entrypoints.openai.translations.protocol import (
...
from vllm_.entrypoints.serve.tokenize.protocol import (
    DetokenizeRequest,
    TokenizeChatRequest,
