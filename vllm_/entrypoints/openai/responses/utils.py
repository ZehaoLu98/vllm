...
from vllm_.entrypoints.openai.chat_completion.protocol import ChatCompletionMessageParam
from vllm_.entrypoints.openai.responses.protocol import ResponseInputOutputItem
